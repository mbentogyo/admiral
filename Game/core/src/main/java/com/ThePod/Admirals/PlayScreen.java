...
public class PlayScreen implements Screen, TurnCallback {
    ...
    public void show() {
        ...
        // 4. Start the game logic (this will call setUp())
    ...
    public void setUp() {
        ...
        this.hudMessage = "Waiting for opponent...";
        enemyBoard.setBoardInteractive(false);
    }
    ...
    public void onMyTurn() {
        ...
        this.hudMessage = "Your Turn: Select a target";
        enemyBoard.setBoardInteractive(true);
    }

    @Override
    public void onEnemyTurn() {
        this.currentState = GameUiState.ENEMY_TURN;
        this.hudMessage = "Enemy Turn...";
        enemyBoard.setBoardInteractive(false);
    }
    ...
    public void myAttack(String message) {
        enterAnimatingState();
        this.hudMessage = message; // "HIT", "MISS", "SUNK [SHIP]"
        
        // Tell the enemy board what happened so it can update its visuals
        enemyBoard.applyMyAttackResult(message, () -> {
    ...
    public void enemyAttack(Coordinates coordinates, AttackResult result, String message) {
        ...
        myBoard.applyEnemyAttack(coordinates, result, () -> {
            // This runs after the animation
    ...
    public void onGameOver(String message) {
        ...
        this.hudMessage = "Game Over: " + message;
        enemyBoard.setBoardInteractive(false);
    }

    @Override
    public void onEnemyReady() {
        this.hudMessage = "Opponent is ready...";
    }
